/*
 * 文件名：QuartzSessionValidationScheduler.java
...
public class QuartzSessionValidationScheduler implements SessionValidationScheduler {
     ...
     *    如果是3600000就得除以1000，为了与源代码一样
     *    
     *@author yangl
     *@see  org.quartz.SimpleScheduleBuilder.withIntervalInSeconds(int intervalInSeconds)
     */
...
//					.startAt(startTime)
					.withSchedule(
							simpleSchedule()
							.withIntervalInSeconds(intervalInSeconds)// 重复间隔
