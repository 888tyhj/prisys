...
<html>
  <head>
    ...
    <link type="text/css" href="documenthandling/uploadify/uploadify.css" rel="stylesheet"  />
    <script type="text/javascript" src="documenthandling/js/jQuery.js"></script>
	<script type="text/javascript" src="documenthandling/js/jquery.clouds.albums.js"></script>
	<script type="text/javascript" src="documenthandling/js/highslide/highslide.js"></script>
	<style type="text/css">
	 .contents{ float:left; width:720px;}
	 .contents h1{ width:720px; height:83px; font-size:24px; line-height:80px; background:url(documenthandling/images/portfolio.png) no-repeat; padding:0 0 0 30px; }
	 ...
	 .listSmall h2 span{ background:url(documenthandling/images/listSingleTitle.png);}
	...
	<script type="text/javascript">
		hs.graphicsDir = 'documenthandling/js/highslide/graphics/';
  ...
  <div id="listSmall" class="listImg listSmall">
	...
	<ul>
	    <c:forEach var="picFile" items="${picFileList}">
		 	 <li>
			 	 <a href="upload/${picFile }">
			 	 	<img src="upload/${picFile }" width="420" height="414">
			 	 </a>
		 	 </li>
	    </c:forEach>
	    <div class="clear"></div>
